...
def local_search(file: Data,
    ...
    count = 0
    while True:
        # escolhe a matriz completa ou uma linha aleatória da matriz
        line = random.choice(routes)
        route = random.choice([line, routes])
        swap(route)
